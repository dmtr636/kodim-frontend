    ...
    return (
        <div className={styles.text}>
            ...
            <p>
                ...
                закона от 14.07.2022. №152-ФЗ «О персональных данных» (далее - Закон о персональных данных) и определяет
                порядок обработки персональных данных и меры по обеспечению безопасности персональных данных,
                предпринимаемые Старостой Кириллом Юрьевичом (далее – Оператор).
                {"\n\n"}
                ...
                веб-сайта <a href={"https://кодим.рф"} target={"_blank"}>https://кодим.рф</a>.
            </p>
            ...
            <p>
                ...
                данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href={"https://кодим.рф"}
                                                                                            target={"_blank"}>https://кодим.рф</a>.
                {"\n\n"}
                ...
                определяемому Пользователю веб-сайта <a href={"https://кодим.рф"} target={"_blank"}>https://кодим.рф</a>.
                {"\n\n"}
                ...
                распространения).
                {"\n\n"}
                2.10. Пользователь – любой посетитель веб-сайта <a href={"https://кодим.рф"}
                                                                   target={"_blank"}>https://кодим.рф</a>.
                {"\n\n"}
            ...
            <p>
                ...
                информационных сообщений, направив Оператору письмо на адрес электронной почты kodimstudio@gmail.com с
            ...
            <p>
                ...
                href={"https://кодим.рф"} target={"_blank"}>https://кодим.рф</a> или
            ...
            <p>
                ...
                kodimstudio@gmail.com с пометкой «Актуализация персональных данных».
                {"\n\n"}
                ...
                Оператору уведомление посредством электронной почты на электронный адрес Оператора kodimstudio@gmail.com
            ...
            <p>
                ...
                персональных данных, обратившись к Оператору с помощью электронной почты kodimstudio@gmail.com.
                {"\n\n"}
                ...
                по адресу <a href={"https://кодим.рф/documents/privacy"}
                             target={"_blank"}>https://кодим.рф/documents/privacy</a>.
            </p>
        </div>
    );
};
