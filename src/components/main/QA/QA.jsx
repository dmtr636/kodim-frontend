  ...
  const QAArray = [
    {
      QAName: "Кто мы?",
      QAText:
        "Мы — небольшая команда единомышленников, которая объединилась в\xA02021 году. Наша цель\xA0–\xA0 внести свой вклад в\xA0развитие интернета. Наша команда использует современный подход в\xA0работе, мы максимально честны и\xA0открыты перед\xA0каждым из\xA0нас и нашим клиентом.",
    },
    {
      QAName: "Чем отличается сайт от веб-приложения?",
      QAText:
        "Под сайтом мы подразумеваем привычный для\xA0многих образ: при\xA0переходах между разделами идут долгие прогрузки страниц. Веб-приложение же максимально приближено к\xA0мобильным приложениям, которые есть у\xA0всех нас на\xA0телефоне. В\xA0качестве примера\xA0—\xA0наш сайт.",
    },
    {
    ...
    },
    {
      ...
      QAText:
        "В отличие от\xA0многих веб-студий, мы используем онлайн‑формат офиса, чем\xA0значительно экономим на\xA0аренде помещения и оборудовании. Также наша команда работает на\xA0основе проектной деятельности, а не на\xA0окладной части. Всё это позволило сделать цены более лояльными для\xA0клиентов.",
    },
    {
