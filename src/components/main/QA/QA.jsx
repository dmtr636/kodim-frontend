...
export const QA = () => {
  ...
  const QAArray = [
    ...
    },
    {
      ...
      QAText:
        "Под сайтом мы подразумеваем привычный для\xA0многих образ: при\xA0переходах между разделами идут долгие прогрузки страниц. Веб‑приложение же максимально приближено к\xA0мобильным приложениям, которые есть у\xA0всех на\xA0телефоне. В\xA0качестве примера\xA0—\xA0наш сайт.",
    },
    {
