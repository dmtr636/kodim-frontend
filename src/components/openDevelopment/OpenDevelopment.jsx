      ...
      <div className={style.textBody}>
        ...
        <div className={style.text}>
          <div className={style.textBlock}>
           {"Если клиент хочет наблюдать за\xA0процессом разработки проекта, то мы предоставляем ему персональную ссылку, где он сможет смотреть за\xA0ходом работы. Это абсолютно бесплатно."}
          </div>
          <div className={style.textBlock}>
